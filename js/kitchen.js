document.addEventListener('DOMContentLoaded', function() {
    fetch('https://ojspain.github.io/Assignments/Dishes.json')
...
function placeDecorations() {
    ...
    if (carousel6) {
        const decorationImage = document.createElement('img');
        decorationImage.src = '../images/nun-chalice.gif';
        decorationImage.alt = 'Nun with two chalices.';
        decorationImage.style.position = 'absolute';
        decorationImage.style.top = '150px';
    ...
    const carousel2 = document.querySelector('#carousel6');

    if (carousel2) {
        // Create a new image element to be placed before the carousel
        const decorationImage = document.createElement('img');
        decorationImage.src = '../images/smug-spin.gif'; // Replace with your image path
