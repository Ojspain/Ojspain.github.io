document.addEventListener('DOMContentLoaded', function() {
    fetch('https://ojspain.github.io/Assignments/Library.json')
...
function placeDecorations() {
    ...
    if (carousel3) {
        ...
        decorationImage.src = '../images/jesus-spin.gif';
        decorationImage.alt = 'Jesus with angels spinning';
    ...
    if (carousel3) {
        const decorationImage = document.createElement('img');
        decorationImage.src = '../images/jesus-sheep.gif';
        decorationImage.alt = 'Jesus leading sheep.';
        decorationImage.style.position = 'absolute';
        decorationImage.style.top = '150px';
    ...
    if (carousel6) {
        ...
        const decorationImage = document.createElement('img');
        decorationImage.src = '../images/cross-spin.gif'; // Replace with your image path
    ...
    if (carousel5) {
        // Create a new image element to be placed before the carousel
        const decorationImage = document.createElement('img');
        decorationImage.src = '../images/flower.gif'; // Replace with your image path
        decorationImage.alt = 'Bouncing flower';
        decorationImage.style.position = 'absolute';
        decorationImage.style.top = '60px';
        decorationImage.style.right = '60vw';
        decorationImage.style.zIndex = '-1';
